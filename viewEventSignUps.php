        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function handleBulk(action) {
                ...
                var tasks = selected.map(function(cb){
                    ...
                    fd.append('position', cb.dataset.role || '');
                        ...
                        ?>
                                <tr>
                                    <?php if ($access_level >= 2): ?>
                                        <td class="select-col">
                                            <?php if ($pending == "0"): ?>
                                                <input type="checkbox" class="bulk-select" value="<?php echo htmlspecialchars($signup['username']); ?>" data-role="<?php echo htmlspecialchars($signup['role']); ?>" data-notes="<?php echo htmlspecialchars($signup['notes']); ?>">
                                            <?php endif; ?>
                                        </td>
                                    <?php endif; ?>
                                    <td><?php echo htmlspecialchars($user_info->get_first_name()); ?></td>
